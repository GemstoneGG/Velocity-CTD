...
public final class IntervalledCounter {
  ...
  /**
   * Initial capacity of the internal ring buffers ({@link #times} and {@link #counts}).
   *
   * <p>This defines how many data points the counter can store before requiring a resize.
   * The buffer automatically grows (doubling in size) when additional capacity is needed.</p>
   */
   ...
   * data points that have fallen outside the interval and updating the running sum.
   */
