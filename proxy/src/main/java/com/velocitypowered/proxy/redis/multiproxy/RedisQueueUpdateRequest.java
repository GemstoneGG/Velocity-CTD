 ...
 *
 * @param queueData The serialized queue data to update across all proxies.
 */
public record RedisQueueUpdateRequest(SerializableQueue queueData) implements RedisPacket {

  /**
   * The identifier for this Redis packet type.
   */
  public static final String ID = "redis-queue-update";
