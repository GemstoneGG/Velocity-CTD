...
/**
 * Represents a packet to handle removing a player from a queue across all proxies.
 ...
 */
public record RedisQueueRemoveRequest(UUID playerUuid, String serverName, boolean maxRetriesReached) implements RedisPacket {

  /**
   * The identifier for this Redis packet type.
   */
  public static final String ID = "redis-queue-remove";
