...
public class LoginSessionHandler implements MinecraftSessionHandler {
  ...
  public boolean handle(LoginPluginMessagePacket packet) {
    ...
    if (configuration.getServerForwardingMode(serverConn.getServerInfo().name()) == PlayerInfoForwarding.MODERN
  ...
  public boolean handle(ServerLoginSuccessPacket packet) {
    if (server.getConfiguration().getServerForwardingMode(serverConn.getServerInfo().name()) == PlayerInfoForwarding.MODERN
  ...
  public void disconnected() {
    if (server.getConfiguration().getServerForwardingMode(serverConn.getServerInfo().name()) == PlayerInfoForwarding.LEGACY) {
