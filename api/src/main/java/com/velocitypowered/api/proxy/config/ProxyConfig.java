...
public interface ProxyConfig {
  ...
  /**
   * If enabled, the proxy will forward private addresses to Mojang.
   *
   * @return whether to forward private addresses to Mojang
   */
  boolean shouldForwardPrivateAddressesToMojang();
