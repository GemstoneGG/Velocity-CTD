...
* Configurable `/ghelp` command that lists all commands a player has access to.
...
* `velocity.command.ghelp` [/ghelp] (Allows you to see what commands you have access to).
